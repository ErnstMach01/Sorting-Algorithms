...
public class Controller {
    ...
    public Controller(){
        BubbleSort Sort = new BubbleSort();                 //Create instance of sort object
        ...
        boolean sorted;                                     //Boolean to check if all values have been sorted
        ...
        for (int k = 0; k < sortData.length; k++) {
            ...
            sorted = Sort.checkSorted(sortData);            //Check if all values are in order
            if(sorted == true) {
                break;                                      //Break out of for loop that does the sorting
            }
        }
